...
use \Nette\Forms\Container, \Nette\Application\UI\Form as AppForm;
...
final class RequestButtonHelper extends \Nette\Object
{
	 ...
	 */
	static public function addRequestButton(Container $form, $name, $caption = NULL, $destination = NULL, $destinationArgs = array())
	{
	 ...
	 */
	static public function addRequestButtonBack(Container $form, $name, $caption = NULL)
	{
